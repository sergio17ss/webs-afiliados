  ...
  const dict = {
    es: {
      ...
      privacidad: {
        ...
        s2Text: 'Recogemos los siguientes datos: (a) Datos de navegación: dirección IP, tipo de navegador, páginas visitadas, duración de la visita. (b) Datos de contacto: si nos escribes, tu nombre y email. (c) Cookies de terceros: Google AdSense y Amazon Afiliados utilizan cookies para mostrar anuncios personalizados y realizar seguimiento de compras.',
        s3Title: '3. Finalidad del tratamiento',
        s3Text: 'Tus datos se utilizan para: (a) Prestar y mejorar nuestros servicios. (b) Mostrar publicidad personalizada mediante Google AdSense. (c) Realizar seguimiento de compras a través de enlaces de afiliado de Amazon. (d) Responder a tus consultas.',
        ...
        s5Text: 'No cedemos tus datos personales a terceros, salvo obligación legal. Sin embargo, utilizamos servicios de terceros que pueden tener acceso a datos anonimizados: Google (AdSense, Analytics) y Amazon (Programa de Afiliados). Estos terceros tienen sus propias políticas de privacidad.',
        ...
        s7Title: '7. Cookies',
        s7Text: 'Este sitio utiliza cookies propias y de terceros para fines técnicos, analíticos y publicitarios. Puedes gestionar tus preferencias de cookies en cualquier momento desde la configuración de tu navegador. Las cookies de Google AdSense y Amazon se utilizan para mostrar anuncios relevantes y medir conversiones.',
      ...
      terminos: {
        ...
        s3Text: 'Este sitio web participa en el Programa de Afiliados de Amazon EU, un programa de publicidad diseñado para proporcionar una comisión por las compras realizadas a través de nuestros enlaces. Esto no afecta al precio que tú pagas. Todos los productos son seleccionados de forma independiente.',
      ...
      afiliados: {
        ...
        metaDesc: 'Información sobre los enlaces de afiliado en DuoStudio. Transparencia sobre el programa de afiliados de Amazon.',
        ...
        s2Title: 'Programa de Afiliados de Amazon',
        s2Text: 'Como afiliados de Amazon, obtenemos ingresos por las compras realizadas a través de nuestros enlaces. Esto no afecta al precio que pagas: el precio es el mismo que si accedieras directamente a Amazon. Amazon utiliza cookies para realizar el seguimiento de las compras.',
