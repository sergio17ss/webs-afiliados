  ...
  const dict = {
    es: {
      ...
      privacidad: {
        ...
        metaDesc: 'Política de privacidad de DuoStudio. Información sobre datos personales, cookies y tus derechos según el RGPD.',
        ...
        s1Text: 'El responsable del tratamiento de tus datos es DuoStudio. Puedes contactarnos a través del formulario de contacto en nuestro sitio web o escribiendo a la dirección indicada en el aviso legal.',
        s2Title: '2. Datos que recogemos',
        s2Text: 'Recogemos los siguientes datos: (a) Datos de navegación: dirección IP, tipo de navegador, páginas visitadas, duración de la visita. (b) Datos de contacto: si nos escribes, tu nombre y email. (c) Cookies de terceros: redes de afiliados y plataformas publicitarias utilizan cookies para mostrar anuncios personalizados y realizar seguimiento de conversiones.',
        s3Title: '3. Finalidad del tratamiento',
        s3Text: 'Tus datos se utilizan para: (a) Prestar y mejorar nuestros servicios. (b) Mostrar publicidad personalizada. (c) Realizar seguimiento de conversiones a través de enlaces de afiliado. (d) Responder a tus consultas.',
        s4Title: '4. Base legal',
        s4Text: 'La base legal para el tratamiento de tus datos es: (a) Tu consentimiento explícito al aceptar las cookies. (b) El interés legítimo en mejorar nuestros servicios. (c) La ejecución de un contrato cuando nos contactas.',
        s5Title: '5. Cesión de datos',
        s5Text: 'No cedemos tus datos personales a terceros, salvo obligación legal. Sin embargo, utilizamos servicios de terceros que pueden tener acceso a datos anonimizados: Google (AdSense, Analytics) y redes de afiliados. Estos terceros tienen sus propias políticas de privacidad.',
        s6Title: '6. Tus derechos',
        s6Text: 'Tienes derecho a: acceder, rectificar, suprimir, limitar el tratamiento, oponerte al tratamiento, y portar tus datos. Para ejercer estos derechos, contáctanos. También tienes derecho a presentar una reclamación ante la Agencia Española de Protección de Datos (AEPD).',
        s7Title: '7. Cookies',
        s7Text: 'Este sitio utiliza cookies propias y de terceros para fines técnicos, analíticos y publicitarios. Puedes gestionar tus preferencias de cookies en cualquier momento desde la configuración de tu navegador. Las cookies de afiliados y plataformas publicitarias se utilizan para mostrar anuncios relevantes y medir conversiones.',
        s8Title: '8. Conservación de datos',
        s8Text: 'Conservamos tus datos personales durante el tiempo necesario para cumplir con las finalidades descritas en esta política, o mientras exista una obligación legal. Los datos de navegación se conservan por un período máximo de 12 meses.',
      },
      terminos: {
        ...
        s4Text: 'Este sitio muestra anuncios de Google AdSense. Google puede utilizar cookies para mostrar anuncios personalizados basados en tus visitas anteriores. Puedes gestionar tus preferencias de anuncios en la configuración de Google.',
    ...
    en: {
      ...
      privacidad: {
        ...
        metaDesc: 'DuoStudio privacy policy. Information about personal data, cookies and your rights under GDPR.',
        ...
        s1Text: 'The data controller for your personal data is DuoStudio. You can contact us through the contact form on our website or by writing to the address indicated in the legal notice.',
        s2Title: '2. Data We Collect',
        s2Text: 'We collect the following data: (a) Browsing data: IP address, browser type, pages visited, visit duration. (b) Contact data: if you write to us, your name and email. (c) Third-party cookies: Google AdSense and Amazon Associates use cookies to display personalised ads and track purchases.',
        s3Title: '3. Purpose of Processing',
        s3Text: 'Your data is used to: (a) Provide and improve our services. (b) Display personalised advertising through Google AdSense. (c) Track purchases through Amazon affiliate links. (d) Respond to your enquiries.',
        s4Title: '4. Legal Basis',
        s4Text: 'The legal basis for processing your data is: (a) Your explicit consent when accepting cookies. (b) Legitimate interest in improving our services. (c) Contract execution when you contact us.',
        s5Title: '5. Data Sharing',
        s5Text: 'We do not share your personal data with third parties, except where required by law. However, we use third-party services that may have access to anonymised data: Google (AdSense, Analytics) and Amazon (Associates Programme). These third parties have their own privacy policies.',
        s6Title: '6. Your Rights',
        s6Text: 'You have the right to: access, rectify, delete, restrict processing, object to processing, and port your data. To exercise these rights, contact us. You also have the right to file a complaint with the Spanish Data Protection Agency (AEPD).',
        s7Title: '7. Cookies',
        s7Text: 'This site uses first and third-party cookies for technical, analytical and advertising purposes. You can manage your cookie preferences at any time from your browser settings. Google AdSense and Amazon cookies are used to display relevant ads and measure conversions.',
        s8Title: '8. Data Retention',
        s8Text: 'We retain your personal data for as long as necessary to fulfil the purposes described in this policy, or as required by law. Browsing data is retained for a maximum period of 12 months.',
      },
      terminos: {
        ...
        s4Text: 'This site displays Google AdSense ads. Google may use cookies to display personalised ads based on your previous visits. You can manage your ad preferences in Google settings.',
